...
- Phase Dash with afterimage trail, invincibility (plus a brief i-frame grace window past the dash for a reliable escape), contact damage scaling with speed, and audio-visual ready cue — carving through a pack now lands a meaty thud + a small camera kick the first time the dash connects; a slightly shorter base cooldown (1.4s) keeps you mobile. Phase Dash **recharges 50% faster while critically wounded** (under 25% HP), and **defeating a boss refills all your banked dash charges**, so your escapes are ready when you need them most
...
### Weapons & Upgrades (33 upgrades)
- **Primary Stats**: Rapid Fire, Power Shot, Overcharge (+18% damage **and** +10% projectile speed per stack, up to 3 — an offensive hybrid), Marksman (+12% damage **and** +18% projectile speed per stack, up to 3 — a precision hybrid for hitscan-feeling shots), Fortify (+20 max HP and heal), Swift, Multi-Shot, Magnet
